...
```bash
python skills/sudis-rebuttal-with-me/scripts/case_tool.py check --case-dir PATH --gate strategy
python skills/sudis-rebuttal-with-me/scripts/case_tool.py check --case-dir PATH --gate draft
python skills/sudis-rebuttal-with-me/scripts/case_tool.py check --case-dir PATH --gate paste-ready
```
