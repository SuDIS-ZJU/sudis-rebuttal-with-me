...
For an executable artifact contribution, distinguish access instructions from substantive scientific discussion. Do not insert ordinary repository links into the rebuttal. Follow the current NeurIPS route for anonymized access and readers.
...
Do not treat a dataset merely as an endpoint, and do not claim that code, data, metadata, consent, or RAI documentation exists unless the author confirmed it. Route serious unresolved ethics or access problems to the AC through the mentor-gated escalation workflow.
